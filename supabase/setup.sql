...
-- ---------------------------------------------------------------------
-- 20260822090000_quote_history_and_leaderboard.sql
-- ---------------------------------------------------------------------
...
DROP POLICY IF EXISTS "quotes public read" ON public.stock_quotes_daily;
...
-- ---------------------------------------------------------------------
-- 20260823090000_leaderboard_values.sql
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 20260824090000_leaderboard_breakdown.sql
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 20260825090000_stock_metrics.sql
-- ---------------------------------------------------------------------
...
DROP POLICY IF EXISTS "metrics public read" ON public.stock_metrics;
...
-- ---------------------------------------------------------------------
-- 20260826090000_leaderboard_live.sql
-- ---------------------------------------------------------------------
...
-- ---------------------------------------------------------------------
-- 20260829090000_live_quotes_and_news_date.sql
-- ---------------------------------------------------------------------
...
DROP FUNCTION IF EXISTS public.league_list();
-- -------------------------------------------------------------- league_list
...
-- ---------------------------------------------------------------------
-- 20260906100000_second_principal_admin.sql
-- ---------------------------------------------------------------------
