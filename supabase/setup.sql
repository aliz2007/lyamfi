...
ALTER TABLE public.profiles ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own profile" ON public.profiles;
...
BEGIN
  ...
  RETURN NEW;
END; $$;DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
...
ALTER TABLE public.stocks ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "stocks public read" ON public.stocks;
...
ALTER TABLE public.stock_prices ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "prices public read" ON public.stock_prices;
...
ALTER TABLE public.lessons ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "lessons public read" ON public.lessons;
...
ALTER TABLE public.lesson_progress ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own progress" ON public.lesson_progress;
...
ALTER TABLE public.portfolios ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own portfolios" ON public.portfolios;
...
ALTER TABLE public.portfolio_positions ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own positions" ON public.portfolio_positions;
...
ALTER TABLE public.portfolio_holdings ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own holdings" ON public.portfolio_holdings;
...
ALTER TABLE public.portfolio_trades ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own trades" ON public.portfolio_trades;
...
ALTER TABLE public.portfolio_snapshots ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own snapshots" ON public.portfolio_snapshots;
...
ALTER TABLE public.stock_fundamentals ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "fundamentals public read" ON public.stock_fundamentals;
...
ALTER TABLE public.portfolio_orders ENABLE ROW LEVEL SECURITY;DROP POLICY IF EXISTS "own orders" ON public.portfolio_orders;
...
BEGIN NEW.updated_at = now(); RETURN NEW; END; $$;DROP TRIGGER IF EXISTS update_portfolio_orders_updated_at ON public.portfolio_orders;
...
DROP POLICY IF EXISTS "read own role or all as admin" ON public.user_roles;DROP POLICY IF EXISTS "read own role or all as admin" ON public.user_roles;
